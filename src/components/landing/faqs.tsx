  ...
  return (
    <MaxWidthWrapper className="h-fit px-3 py-20" isTopAccent={false}>
      ...
      <Accordion
        ...
        defaultValue="item-1"
      >
        <AccordionItem value="item-1" className="w-full rounded-xl border bg-white shadow">
          <AccordionTrigger className="w-full p-4 font-medium">What is DigiMark Developers?</AccordionTrigger>
        ...
        <AccordionItem value="item-2" className="w-full rounded-xl border bg-white shadow">
        ...
        <AccordionItem value="item-3" className="w-full rounded-xl border bg-white shadow">
          <AccordionTrigger className="w-full p-4 font-medium">
        ...
        <AccordionItem value="item-4" className="w-full rounded-xl border bg-white shadow">
          <AccordionTrigger className="w-full p-4 font-medium">
        ...
        <AccordionItem value="item-5" className="w-full rounded-xl border bg-white shadow">
          <AccordionTrigger className="w-full p-4 font-medium">
        ...
        <AccordionItem value="item-6" className="w-full rounded-xl border bg-white shadow">
          <AccordionTrigger className="w-full p-4 font-medium">
        ...
        <AccordionItem value="item-7" className="w-full rounded-xl border bg-white shadow">
          <AccordionTrigger className="w-full p-4 font-medium">
        ...
        <AccordionItem value="item-8" className="w-full rounded-xl border bg-white shadow">
          <AccordionTrigger className="w-full p-4 font-medium">
        ...
        <AccordionItem value="item-9" className="w-full rounded-xl border bg-white shadow">
          <AccordionTrigger className="w-full p-4 font-medium">
        ...
        <AccordionItem value="item-10" className="w-full rounded-xl border bg-white shadow">
          <AccordionTrigger className="w-full p-4 font-medium">Do you provide Post launch support?</AccordionTrigger>
          <AccordionContent className="flex flex-col gap-4 text-balance">
            <p>
